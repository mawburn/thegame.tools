...
export const title = 'Root.TheGame.tools' as const
const descr = 'Unofficial Root RPG roll tables' as const
  ...
  render() {
    return (
      <Html lang="en">
        ...
        <body className="mb-10 min-h-screen bg-[url('/bg.jpg')]">
          <NavBar className="drop-shadow-md" subText={descr} links={[]} />
          <SponsoredBy />
          <Main />
          <Footer />
          <NextScript />
